...
export function normalizeSmsPhone(value: string | null | undefined, defaultCountryCode = "55") {
...
export function tryNormalizeSmsPhone(value: string | null | undefined, defaultCountryCode = "55") {
  try {
    return {
